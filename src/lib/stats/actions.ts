...
/**
 * Lädt Einheiten mit vorhandener Prognose und Feedback für den Radar-Vergleich.
 * Der Client aggregiert diese Daten nach aktivem Zeitraum-/Typ-/Disziplin-Filter.
 */
